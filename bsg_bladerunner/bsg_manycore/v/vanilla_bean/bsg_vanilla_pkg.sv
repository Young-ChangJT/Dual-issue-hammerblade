`ifndef BSG_VANILLA_PKG_SV
`define BSG_VANILLA_PKG_SV
...
typedef struct packed
{
    ...
    instruction_s                      instruction1;      // Instr 1
    decode_s                           decode1;           // Decode signals 1
    fp_decode_s                        fp_decode1;        // FP Decode 1
    logic [RV32_reg_data_width_gp-1:0] pred_or_jump_addr1;// Jump target PC 1
    logic                              branch_predicted_taken1;
